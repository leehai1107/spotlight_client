      ...
      createView: function (isSearching, setSize, refresh) {
        ...
        function scroll(scrollTop, init) {
          ...
          if (that.activeIndex !== undefined) {
            prevActive = (
              that.selectpicker.main.data[that.prevActiveIndex] || {}
            ).element;
            active = (that.selectpicker.main.data[that.activeIndex] || {})
              .element;
            selected = (that.selectpicker.main.data[that.selectedIndex] || {})
              .element;
          ...
          if (init || positionIsDifferent) {
            ...
            if (
              ((!isSearching && that.options.source.load) ||
      ...
      buildData: function (data, type) {
        ...
        function addOption(item, config) {
          ...
          if (config.divider === true) {
            ...
            var liIndex = mainData.length + startLen,
              ...
              optionClass =
                (item.className || "") + (config.optgroupClass || "");
        ...
        function addOptgroup(index, selectOptions) {
          var optgroup = selectOptions[index],
            ...
            previous =
              index - 1 < startIndex ? false : selectOptions[index - 1],
