  ...
  describe("Toggle", () => {
    describe("OR", () => {
      ...
      it("should build up a compound selector as toggles are activated", () => {
        ...
        let totalMatching = container.querySelectorAll(
      ...
      it("should activate the appropriate toggle controls on load for an OR compound selector", () => {
        ...
        chai.assert.isTrue(
          toggleA.classList.contains("mixitup-control-active")
        );
        chai.assert.isTrue(
          toggleC.classList.contains("mixitup-control-active")
        );
      });
    });
